...
| 2024-09-30 Vodafone Idea AS55410  | RFC 7908 Type-1 leak   | `customer_cone_leak` |  ✅     | AS55410 (Vi India) propagated 224 distinct prefixes between its two tier-1 upstreams AS9498 (Bharti Airtel) and AS45528 (Tata Communications) with a 6× AS55410 path-prepend. Detection on the 9,394-path window: **43 valley-free alerts + 1,015 customer-cone alerts**, all entirely through AS55410. CAIDA serial-2 snapshot: 20240901 |
| 2017-04-26 Rostelecom financials  | sub-prefix hijack      | `subprefix_hijack` |    ✅     | AS12389 briefly re-announced ~36 prefixes belonging to Mastercard, Visa, USPS, and other US financial networks. Onset at RRC00: **2017-04-26 22:36:39Z** via the canonical Russian path `3333 1273 12389`. Detection on 7-row hand-curated baseline (RIB snapshot at 2017-04-26T16:00Z, the most recent before onset): **4 subprefix_hijack alerts** on verified victim prefixes (216.119.216.0/24 → AS26380, 198.241.161.0/24 → AS2559, etc.) |
